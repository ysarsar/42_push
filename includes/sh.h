...
/*   Updated: 2020/12/03 20:37:55 by hiantrin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					join_with_something(char **line, char *str,
						int a, int i);
void					join_with_anything2(char **line,
						char *str, int a, int i);
...
void					norme_to_cd(t_process *process, t_job *job,
						char **argv, int i);
...
char					*replace_by_s_q(char *str, int *start,
						int *end, int type);
...
int						if_three(char *file2, int out, int type,
						t_process **process);
int						if_four(char *file2, int out, int type,
						t_process **process);
...
int						semi_sub(char **str, int i);
int						final_trait(char *str, t_process **process,
						t_job **job);
int						help_trait_it_sub(char *str, int i, int j, int *b);
int						half_checker_for_re_sub(char *str, int i, int j, int a);
int						print_error_sub(char *tmp, char a);
int						print_error_one_word(char *str, int i);
int						check_for_end_pipe(char *str, int i, char c, char *tmp);
int						help_trait_v3(t_process **process, t_job **j,
						int *count, int a);
...
int						norme_read_the_parent(char *str, int i,
						int *j, char *b);
...
int						test_string(char **args, t_process *process);
...
void					aff_hashtable(t_hash **h_table, t_process *process);
...
void					ft_print_one_alias(char *alias, t_alias
						*g_alias, t_process *p);
