...
/*   Updated: 2020/12/03 18:32:28 by hiantrin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		check_if_and_and(char **str, int i, int j)
{
	while (1)
	{
		...
		while (str[0][i])
			i++;
		i--;
		if (i == 0 && str[0][i] != 34 && str[0][i] != 39 && str[0][i] != 92)
			break ;
		while (i != 0 || (i == 0 && (str[0][i] == 34 ||
			str[0][i] == 39 || str[0][i] == 92)))
		{
